...
function createNewUser(){
    ...
    }else if(localStorage.getItem(userData.email)){
        console,console.log("Your Account is Already Created...");
...
function checkLogin(){
    ...
    if(loginEmail !='' && loginPassword != ''){
        localStorage.getItem(loginEmail)==loginPassword ? alert("Login..") : alert("Please Try Again..")
    }else{
